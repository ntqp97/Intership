...
//void Node::WriteToFile(ofstream& fWrite)
//{
//	Node* p = this;
//	while (p->Next->Data->getType() != 3)
//		p = p->next;
//	while (p->next != NULL)
//	{
//		Student* s = (Student*)p->next->data;
//		fWrite << "Name: " << s->getName() << endl;
//		fWrite << "ID: " << s->getID() << endl;
//		fWrite << "Grade: " << s->getGrade() << endl;
//		fWrite << "Number of project: " << s->getNumOfProject() << endl;
//		fWrite << "Score respectively: " << endl;
//		float* a = s->getScore();
//		for (register int i = 0; i < s->getNumOfProject(); i++) {
//			fWrite << "Project " << i << ": " << a[i] << endl;
//		}
//		fWrite << endl;
//		p = p->next;
//	}
//}
//
//void Node::ReadFile(ifstream& fRead)
//{
//	Node *temp = this;
//
//	fRead >> count[3];
//	for (register int i = 0; i < count[3]; i++)
//	{
//		Node *sv = new Node;
//		sv->data = new Student;
//		Student* s = (Student*)sv->data;				//downcasting
//		s->readFile(fRead);
//		sv->next = NULL;
//		temp->next = sv;
//		temp = temp->next;
